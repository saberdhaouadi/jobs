...
public class GCEProvisioner implements ProvisionerInterface {
  ...
  static final String GOOGLE_API_ENDPOINT =
  ...
  public static Compute createComputeService()
  ...
  private Instance createInstance(String project, String zone,
    ...
    instance.setMachineType(GOOGLE_API_ENDPOINT + project + "/zones/" + zone +
    ...
    //FIXME: make configurable scopes ?
  ...
  public int getNumberOfRunningInstances(boolean preemptible) {
    ...
    try {
      Compute.Instances.List request = computeService.instances().list(
          cmdArgs.getProject(), cmdArgs.getRegion());
      ...
      // TODO: Responses from GCP API are paginated we probably need to go
  ...
  public CommandLineArguments getCmdArgs() { return cmdArgs; }

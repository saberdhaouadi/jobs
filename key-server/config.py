...
classpath = [
  ...
  '$(lb_web)/lib/java/httpclient-4.3.jar',
  '$(lb_web)/lib/java/httpcore-4.3.jar',
  '$(lb_web)/lib/java/jackson-annotations-2.3.0.jar',
  '$(lb_web)/lib/java/jackson-core-2.3.2.jar',
  '$(lb_web)/lib/java/jackson-databind-2.3.2.jar',

  ...
  prod =
    { hostName = "steve.logicblox.com";
      ...
      workers = addOnDemandQueues {
        ...
        "i2.xlarge" = { number = 0; price = "0.86"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "200"; min = "75";  keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.xlarge"; subnetId = "subnet-01c31086f64d5d173"; inherit securityGroup;};
        "i2.2xlarge" = { number = 0; price = "1.88"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "500"; min = "75"; onDemand = true; maxDelta = "100";  keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.2xlarge"; subnetId = "subnet-01c31086f64d5d173"; inherit securityGroup; };
        "i2.4xlarge" = { number = 0; price = "3.72"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "300"; min = "75";  keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.4xlarge"; subnetId = "subnet-01c31086f64d5d173"; inherit securityGroup; };

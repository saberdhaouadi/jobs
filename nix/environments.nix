  ...
  prod =
    { hostName = "steve.logicblox.com";
      ...
      workers = addOnDemandQueues {
        ...
        "r3.2xlarge" = { number = 0; price = "0.625"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "650"; onDemand = true; maxDelta = "100"; keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.2xlarge"; subnetId = "subnet-04b4129d5184e8a0f"; inherit securityGroup; };
        ...
        "r3.8xlarge" = { number = 0; price = "3.00"; percentageSpot = "1.0"; percentageQueue = "1.0"; min = "50"; max = "500"; onDemand = true; maxDelta = "50"; keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.8xlarge"; subnetId = "subnet-04b4129d5184e8a0f" ;inherit securityGroup;};
        ...
        "i2.2xlarge" = { number = 0; price = "0.625"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "500"; min = "75"; onDemand = true; maxDelta = "100";  keyService = "https://54.167.63.233/keys"; diskSize = "10"; instanceType = "i3.2xlarge"; subnetId = "subnet-04b4129d5184e8a0f"; inherit securityGroup; };
        ...
        "i3.16xlarge" = { number = 0; price = "2.50"; keyService = "https://54.167.63.233/keys"; percentageSpot = "1.0"; percentageQueue = "1.0"; max = "200"; min = "75"; diskSize = "10"; instanceType = "i3.8xlarge";  subnetId = "subnet-062fba8acc7b8ed99";  inherit securityGroup; ami = "ami-0d246ae35f95bd215"; };

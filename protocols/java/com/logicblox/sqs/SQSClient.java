...
public final class SQSClient implements SQSClientInterface {
   ...
   *
   * @param endpoint the URL for the endpoint (the SQS region).
   * @param client   an instance of AmazonSQSClient to be wrapped by this client
   */
   ...
   *
   * @param handle      the identification of the queue from which to get messages.
   * @param maxMessages the maximum number of messages to retrieve.
   * @param attributes  whether to get messages with extra attributes.
